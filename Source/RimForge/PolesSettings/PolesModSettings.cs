...
namespace RimForge.PolesSettings;

public class PolesModSettings : ModSettings
{
    ...
    public static List<SettingsEntry> GetAllEntries()
    {
        ...
        foreach (var field in typeof(PolesModSettings).GetFields(BindingFlags.Public | BindingFlags.Static))
        {
    ...
    public override void ExposeData()
    {
        foreach (var item in GetAllEntries())
        {
            ...
            {
                PolesCore.Error($"Exception exposing settings data for '{item.Field.Name}':", e);
            }
        }
    }
    ...
    public static void DrawUI(Rect area)
    {
        ...
        foreach (var item in GetAllEntries())
        {
            ...
            {
                PolesCore.Error($"Exception drawing settings item '{item.Label}':", e);
            }
        }
...
{
    public static List<SettingsEntry> all;
    ...
    public virtual void ExposeData()
    {
        ...
        PolesCore.Error($"Unhandled setting type: {type.FullName}");
    }
